...
$sql_code = "SELECT id, calldate, clid, src, dst, lastdata, duration, disposition FROM cdr WHERE DATE(`calldate`) = CURDATE() ORDER BY id DESC";
...
<script>
    $(document).ready(function(){
        $('#id_da_tabela').DataTable({
            "language": {
                "lengthMenu": "Mostrando _MENU_ registros de HOJE por página ",

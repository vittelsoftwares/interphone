...
$sql = mysqli_query($mysqli,"SELECT MAX(id) FROM anuncios");
                ...
                <div class="row">
                    <div class="form-group .col-xs-6 .col-sm-3">
                        ...
                        <div class="inner-addon left-addon">
                            ...
                            <input type="text" class="form-control" name="id" value="<?php echo $idanuncio; ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="4" size="4" disabled>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="jumbotron">
                        <div class="form-group .col-xs-6 .col-sm-3">
                            ...
                            <div class="inner-addon left-addon">
                                ...
                                <select class="form-control padding">
                                    <?php if($num > 0){ ?>
                                        <?php do{ ?>
                ...
                <div class="row">
                    <div class="form-group .col-xs-6 .col-sm-3">
                        ...
                        <div class="inner-addon left-addon">
                            ...
                            <select class="form-control padding" required>
    ...
    border-top: 1px solid rgba(229, 222, 225, 0);">
            ...
            <?php if($num2 > 0){ ?>
                <table data-order='[[ 1, "desc" ]]' data-page-length='10' class="table table-bordered table-hover" id="id_da_tabela2" style="font-size: 12px">
                    <thead>
                    <tr>
                        <th><input type="checkbox" name="selectall2" onClick="toggle(this)" /></th>
                        <th>ID</th>
                        <th>Nome</th>
                        <th>Quadra/Lote</th>
                    </tr>
                    ...
                    do{ ?>
                        <tr>
                            <td><input type="checkbox" name="selectall"value="<?php echo $moradores['id']; ?>"></td>
